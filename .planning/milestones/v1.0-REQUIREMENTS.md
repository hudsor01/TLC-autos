...
- [x] **FORM-02**: Customer form uses @tanstack/react-form with Zod validation
- [x] **FORM-03**: Lead form uses @tanstack/react-form with Zod validation
- [x] **FORM-04**: Deal form uses @tanstack/react-form with Zod validation
...
- [x] **PUB-02**: Public vehicle detail page shows all images and specs
- [x] **PUB-03**: Contact form submits leads to database with validation
